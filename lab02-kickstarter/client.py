...
from constants import DEFAULT_ADDR, DEFAULT_PORT, CODE_OK, EOL, FILE_NOT_FOUND
...
def main():
    ...
    parser.add_option("-v", "--verbose",
                      ...
                      help="Determina cuanta informacion de depuracion a"
                      "mostrar (valores posibles son: ERROR, WARN, INFO,"
                      " DEBUG)",
                      default="ERROR")
